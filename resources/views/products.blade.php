...
<body>
  ...
  <div class="container">
    ...
    @csrf
    <input type="hidden" name="id" value="1"> <!-- Replace with dynamic ID -->
    <input type="hidden" name="name" value="Call of Duty: Black Ops 6">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="2"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Resident Evil 4: Gold Edition">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="3"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="The Last of Us">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="4"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Grand Theft Auto V (GTA V)">
          ...
          <div class="col">
            <div class="card game-card">
              ...
              <div class="card-body">
                ...
                <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="5"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Minecraft (PS5 Edition)">
...
<div class="col">
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="6"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Skull Island: Rise of Kong">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="7"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Hogwarts Legacy">
                <input type="hidden" name="price" value="49.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="8"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Halo Infinite">
                <input type="hidden" name="price" value="59.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="9"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Goat Simulator 3">
                <input type="hidden" name="price" value="39.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            <h5 class="card-title">Starship Troopers: Extermination</h5>
            <div class="rating">
                <span class="text-warning">⭐ 4.6</span>
            </div>
            <p class="card-text">£44.99</p>
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="10"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Starship Troopers: Extermination">
                <input type="hidden" name="price" value="44.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="11"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Super Mario Odyssey">
                <input type="hidden" name="price" value="49.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="12"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="The Legend of Zelda">
                <input type="hidden" name="price" value="59.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="13"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Carnival Games">
                <input type="hidden" name="price" value="29.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="14"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Splatoon 3">
                <input type="hidden" name="price" value="39.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="24"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Mario Kart 8 Deluxe">
                <input type="hidden" name="price" value="44.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="15"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="The Last of Us Part II">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="16"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Borderlands 3">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="17"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Sniper Elite 4">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="18"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Call of Duty: Cold War">
                <input type="hidden" name="price" value="57.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="25"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Star Wars Jedi: Fallen Order">
                <input type="hidden" name="price" value="49.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
  ...
  <div class="row row-cols-5">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="19"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Cyberpunk 2077">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="20"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Shadow of the Tomb Raider">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="21"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Gears 5">
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="22"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Grand Theft Auto V">
                <input type="hidden" name="price" value="29.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
    ...
    <div class="card game-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('cart.add') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="23"> <!-- Replace with dynamic ID -->
                <input type="hidden" name="name" value="Call of Duty: Modern Warfare">
                <input type="hidden" name="price" value="39.99">
                <button type="submit" class="btn cart-btn">Add to Cart</button>
            </form>
        </div>
